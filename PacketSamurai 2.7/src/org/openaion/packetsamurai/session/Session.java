package org.openaion.packetsamurai.session;
...
import org.openaion.packetsamurai.crypt.NullCrypter;
import org.openaion.packetsamurai.crypt.ProtocolCrypter;
import org.openaion.packetsamurai.logwriters.PSLogWriter;
...
public class Session 
{
    ...
    private void init(boolean crypted)
    {
        if (crypted && _decrypt)
        {
            try
            {
                Class<?> clazz = Class.forName("org.openaion.packetsamurai.crypt."+_protocol.getEncryption()+"Crypter");
