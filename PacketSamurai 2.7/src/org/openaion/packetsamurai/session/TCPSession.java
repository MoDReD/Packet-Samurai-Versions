...
import org.openaion.packetsamurai.session.packetbuffer.DefaultPacketBuffer;
import org.openaion.packetsamurai.session.packetbuffer.PacketBuffer;
...
public class TCPSession extends Session
{
    ...
    private void initBuffers()
    {
        ...
        try
        {
            clazz = Class.forName("org.openaion.packetsamurai.session.packetbuffer."+pBufType);
            if(clazz == null)
            {
