package org.openaion.packetsamurai;
...
public class Util 
{
	...
	public static String makeFormatString(List<?> parts)
	{
		TextBuilder tb = new TextBuilder();
		for (Object _part : parts)
		{
			if (_part instanceof Part)
			{
				Part part = (Part)_part;
				...
				if (_part instanceof PartType)
				{
					PartType part = (PartType) _part;
					{
