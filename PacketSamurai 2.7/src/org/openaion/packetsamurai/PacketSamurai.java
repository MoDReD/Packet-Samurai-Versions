...
import org.openaion.packetsamurai.protocol.ProtocolManager;
...
public class PacketSamurai
{
	...
	public static final String CONFIG_FILE = "config"+System.getProperty("file.separator")+"ps.properties";
