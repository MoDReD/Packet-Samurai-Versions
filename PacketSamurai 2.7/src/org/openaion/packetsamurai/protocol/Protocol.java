package org.openaion.packetsamurai.protocol;
...
import org.openaion.packetsamurai.Util;
...
import org.openaion.packetsamurai.parser.formattree.PartContainer;
import org.openaion.packetsamurai.parser.formattree.SwitchCaseBlock;
import org.openaion.packetsamurai.parser.formattree.SwitchPart;
import org.openaion.packetsamurai.parser.parttypes.RawPartType;
import org.openaion.packetsamurai.parser.valuereader.Reader;
    ...
    private Part parsePart(Node n, PartContainer pc)
    {
        ...
        for (Node subNode = n.getFirstChild(); subNode != null; subNode = subNode.getNextSibling())
        {
            ...
            if ("reader".equals(subNode.getNodeName()))
            {
                ...
                try
                {
                    clazz = Class.forName("org.openaion.packetsamurai.parser.valuereader."+atr.getNodeValue()+"Reader");
                }
