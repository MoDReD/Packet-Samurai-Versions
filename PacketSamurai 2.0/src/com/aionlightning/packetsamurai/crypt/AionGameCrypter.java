...
public class AionGameCrypter implements ProtocolCrypter
{
	 ...
	 * Old code was 0x44 but that causes errors now.
	 * Note: 1.5.x (0x54 works too, but not with 1.5.1.10)
	 */
	public final static byte	staticServerPacketCode	= 0x55;
    ...
    public boolean decrypt(byte[] raw, packetDirection dir)
    {
        ...
        else
        {
            if (clientPacketkey == null)
            {
                if(!validatePacket(raw, staticServerPacketCode))
