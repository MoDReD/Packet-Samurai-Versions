...
import com.aionlightning.packetsamurai.Captor;
import com.aionlightning.packetsamurai.IUserInterface;
import com.aionlightning.packetsamurai.PacketSamurai;
import com.aionlightning.packetsamurai.gui.logrepo.LogRepoTab;
import com.aionlightning.packetsamurai.gui.protocoleditor.ProtocolEditor;
...
public class Main implements IUserInterface {
	...
	public void init() {
		...
		_frame.setMinimumSize(new Dimension(750, 500));
	...
	public class MenuActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			if (actionCmd.equals("Open")) {
				final JFileChooser chooser = new JFileChooser(PacketSamurai.getConfigProperty("lastLogDir", "."+File.separator+"logs"+File.separator));
