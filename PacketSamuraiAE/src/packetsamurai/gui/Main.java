...
import packetsamurai.Captor;
import packetsamurai.IUserInterface;
import packetsamurai.PacketSamurai;
import packetsamurai.gui.logrepo.LogRepoTab;
import packetsamurai.gui.protocoleditor.ProtocolEditor;
import packetsamurai.logreaders.AbstractLogReader;
import packetsamurai.session.DataPacket;
import packetsamurai.session.GameSessionTable;
import packetsamurai.session.Session;
import packetsamurai.utils.NpcGatherExporter;
import packetsamurai.utils.NpcInfoExporter;
import packetsamurai.utils.NpcShoutExporter;
import packetsamurai.utils.NpcSpawnExporter;
import packetsamurai.utils.NpcStateExporter;
import packetsamurai.utils.NpcStaticExporter;
import packetsamurai.utils.NpcTitleExporter;
import packetsamurai.utils.NpcWalkExporter;
import packetsamurai.utils.PetFeedExporter;

//import packetsamurai.utils.NpcPositionExporter;
...
public class Main implements IUserInterface {
	...
	public void init() {
		_frame = new JFrame("Packet Samurai [Aion-Extreme - 3.0+]");
