...
import packetsamurai.crypt.NullCrypter;
import packetsamurai.crypt.ProtocolCrypter;
...
public class Session 
{
    ...
    private void init(boolean crypted)
    {
        if (crypted && _decrypt)
        {
            try
            {
                Class<?> clazz = Class.forName("packetsamurai.crypt."+_protocol.getEncryption()+"Crypter");
