...
import packetsamurai.session.packetbuffer.DefaultPacketBuffer;
import packetsamurai.session.packetbuffer.PacketBuffer;
...
public class TCPSession extends Session
{
    ...
    private void initBuffers()
    {
        ...
        try
        {
            clazz = Class.forName("packetsamurai.session.packetbuffer."+pBufType);
            if(clazz == null)
            {
