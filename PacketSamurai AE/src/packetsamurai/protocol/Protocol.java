package packetsamurai.protocol;
...
import packetsamurai.parser.formattree.SwitchPart;
import packetsamurai.parser.parttypes.RawPartType;
import packetsamurai.parser.valuereader.Reader;
    ...
    private Part parsePart(Node n, PartContainer pc)
    {
        ...
        for (Node subNode = n.getFirstChild(); subNode != null; subNode = subNode.getNextSibling())
        {
            ...
            if ("reader".equals(subNode.getNodeName()))
            {
                ...
                try
                {
                    clazz = Class.forName("packetsamurai.parser.valuereader."+atr.getNodeValue()+"Reader");
                }
