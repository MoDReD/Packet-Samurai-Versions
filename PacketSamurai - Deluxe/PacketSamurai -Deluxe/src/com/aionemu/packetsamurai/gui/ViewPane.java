...
public class ViewPane extends JPanel {
	...
	public ViewPane(GameSessionViewer gsv) {
		...
		JScrollPane hexDumpScrollPane = new JScrollPane(_hexDumpArea, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
			...
			if (e.getSource() == _table.getSelectionModel()) {
				...
				if (_currentSelectedPart != null) {
					...
					try {
						...
						_hexStyledDoc.insertString(_currentSelectedPart.getOffset(), text,
